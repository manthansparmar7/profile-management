...
Donate link: https://www.manthansparmar.com/
Tags: comments, spam
...
After downloading, please rename the folder from `Profile-Management-master` to `profile-management` and then upload it to the `wp-content/plugins` directory.
